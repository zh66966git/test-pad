  ...
  export default {
    ...
    data(){
      return{
        ...
        jsonTaskList:JSON.parse(localStorage.getItem('localTaskList')),//从localStorage中获取到的全部任务
        taskArr:[],//任务详情初始态
        cidSelected:'110100-110000221958',//建筑选择初始态
        newTaskArr:[{'开机点':[70,580]},{'开机点':[70,580]}],//新建任务列表初始态
...
//            data:Object.values(this.taskIngArr[this.currentTaskCounter])[0][this.currentDotCounter]
//          });
...
//        this.currentState++;
      ...
      newTaskCancel:function () {
        console.log('取消新建任务');
        this.newTaskArr=[{'开机点':[70,580]},{'开机点':[70,580]}];
        this.canvasEmpty();
      },//取消新建任务
      newTaskFinish:function () {
        ...
        this.newTaskArr=[{'打印区':'116.23456,22.23456'},{'打印区':'116.23456,22.23456'}];
        localStorage.setItem('localTaskList',JSON.stringify(this.jsonTaskList) );
        this.canvasEmpty()
      },//完成新建任务
      addDot:function (arr) {
